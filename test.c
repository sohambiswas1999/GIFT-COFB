...
#define print_round_key \
    printf("W7:%08x,W6:%08x,W5:%08x,W4:%08x,W3:%08x,W2:%08x,W1:%08x,W0:%08x\n", W[7], W[6], W[5], W[4], W[3], W[2], W[1], W[0]);
...
uint8_t Key[16] = {0x47, 0x4c, 0x5f, 0x29, 0x1f, 0x7b, 0x8a, 0xa6, 0x31, 0x38, 0x70, 0x9b, 0xf8, 0xf1, 0x48, 0x0e};

void main()
{
    uint8_t C[16];
    giftb128(input, Key, C);
}